...
import { ProptyBlueprint, ProptyRoadmapSummary } from "@/components/companies/ProptyBlueprint";
...
export default function CompaniesPage() {
  return <article className="co-page">
    ...
    <nav className="co-section-nav" aria-label="Decision summary sections"><a href="#company-table-title">1. Compare companies</a><a href="#propty-features">2. Choose Propty features</a><a href="#propty-roadmap">3. Discuss the roadmap</a></nav>
