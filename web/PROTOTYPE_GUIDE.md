...
- The original six homes each have a three-photo inspiration collage: a large lead photo with two stacked images on desktop, and two previews below the lead photo on phones. Each tile opens its corresponding photo. The viewer retains keyboard arrows, image count and animated open/close. These are separate licensed interiors, not rooms of one actual apartment. Other homes retain a single photo without empty collage cells.
